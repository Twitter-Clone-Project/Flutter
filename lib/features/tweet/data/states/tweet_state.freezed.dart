...
class _$TweetStateImpl implements _TweetState {
  ...
  @override
  String toString() {
    return 'TweetState(retweetrsList: $retweetrsList, likersList: $likersList, errorMessage: $errorMessage, loading: $loading, screenIndex: $screenIndex)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, retweetrsList, likersList,
      errorMessage, loading, screenIndex);
