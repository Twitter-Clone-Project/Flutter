...
class _TweetComposeState extends State<TweetCompose> {
  ...
  late var likeIcon = AssetsConstants.likeOutlinedIcon;
  ...
  void initState() {
    super.initState();
    likeIcon = AssetsConstants.likeOutlinedIcon;
        ...
        Row(
          ...
          children: [
            IconButton(
              ...
              icon: SvgPicture.asset(AssetsConstants.commentIcon),
            ),
            Text(formatCount(commentCount),
                style: const TextStyle(fontSize: 14, color: Palette.greyColor)),
            ...
            IconButton(
              ...
              icon: SvgPicture.asset(AssetsConstants.retweetIcon),
            ),
              ...
              onPressed: () {
                setState(() {
                  if (likeCount == likeCountBeforeMe) {
                    likeCount += 1; // like
                    likeIcon = AssetsConstants.likeFilledIcon;
                  } else {
                    likeCount -= 1; // dislike
                    likeCountBeforeMe = likeCount;
                    likeIcon = AssetsConstants.likeOutlinedIcon;
            ...
            IconButton(
                onPressed: () {},
                icon: SvgPicture.asset(AssetsConstants.viewsIcon)),
