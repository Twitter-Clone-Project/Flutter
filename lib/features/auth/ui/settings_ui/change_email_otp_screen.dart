...
const ChangeEmailOtpScreen({super.key,required this.email});
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => ChangeEmailOtpScreenState();
}

class ChangeEmailOtpScreenState extends ConsumerState<ChangeEmailOtpScreen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 0), () {
      ref
          ...
          .updateEmail(newEmail: widget.email);
    });
