...
class _ProfileScreenState extends ConsumerState<ProfileScreen>
                              ...
                              case "unblock":
                                {
                                  ...
                                  showFlushbar(context, success, "You unblocked ${userProfile.username}"," Unblock failed, try again later");
                                }
                                break;
                              case "block":
                                bool success = await ref
                                    .read(profileNotifierProvider.notifier)
                                    .toggleBlockStatus(userProfile.username!);
                                showFlushbar(context, success, "You blocked ${userProfile.username}"," block failed, try again later");
                                break;
                              case "unmute":
                                bool success = await ref
                                    .read(profileNotifierProvider.notifier)
                                    .toggleMuteStatus(userProfile.username!);
                                showFlushbar(context, success, "You unmuted ${userProfile.username}"," Unmute failed, try again later");
                                break;
                              case "mute":
                                bool success = await ref
                                    .read(profileNotifierProvider.notifier)
                                    .toggleMuteStatus(userProfile.username!);
                                showFlushbar(context, success, "You muted ${userProfile.username}"," mute failed, try again later");
                                break;
                            }
                          },
                                ...
                                children: [
                                  ...
                                  const Divider(
                                    ...
                                    Padding(
                                        ...
                                        child: CustomText("You are blocked from following @${userProfile.username} and viewing @${userProfile.username}'s posts.",
                                          color: AppColors.lightThinTextGray,
                                        ),
                                      ),
                                ],
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (confirmUnfollow == true) {
                                                          ...
                                                          bool success = await ref
                                                              ...
                                                              userProfile
                                                                  .username!);
                                                          showFlushbar(context, success, "You unfollowed ${userProfile.username}"," Unfollow failed, try again later");
  ...
  void showFlushbar(BuildContext context, bool success, String successful, String failed) {
    Flushbar(
      message: success
          ? successful
          : failed,
