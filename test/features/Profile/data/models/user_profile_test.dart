...
void main() {
  group('UserProfile', () {
    test('fromJson should correctly deserialize JSON', () {
      ...
      expect(userProfile.bio, 'Software Developer');
      expect(userProfile.website, 'https://www.johndoe.com');
      expect(userProfile.location, 'City');
      expect(userProfile.profileImageUrl, 'https://www.example.com/image.jpg');
      expect(userProfile.createdAt, '2023-01-01T12:00:00Z');
    });
